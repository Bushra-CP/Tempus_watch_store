...
const strapMaterial = variant.querySelector('[name="strapMaterial"]').value.trim();
...
const caseMaterial = variant.querySelector('[name="caseMaterial"]').value.trim();
const stockQuantity= variant.querySelector('[name="stockQuantity"]').value.trim();
const actualPrice  = variant.querySelector('[name="actualPrice"]').value.trim();
